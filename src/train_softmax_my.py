...
from symbols import fmobilefacenet
...
from eval import verification2 as verification
import sklearn
...
def parse_args():
  ...
  # general
  parser.add_argument('--data-dir', default='/Users/wangyiran/Documents/dataset_train/', help='training set directory')
  parser.add_argument('--prefix', default='../my_model/', help='directory to save model.')
  parser.add_argument('--pretrained', default='../datasets/model-r50-am-lfw/model,0000', help='pretrained model to load')
  ...
  parser.add_argument('--verbose', type=int, default=1000, help='do verification testing and model saving every verbose batches')
  ...
  parser.add_argument('--margin-m', type=float, default=0.1, help='margin for loss')
  ...
  parser.add_argument('--target', type=str, default='valid', help='verification targets')
