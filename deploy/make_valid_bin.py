...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', default='/Users/wangyiran/Documents/dataset_train/valid.bin', help='path to save.')
    parser.add_argument('--txtfile', default='/Users/wangyiran/Documents/dataset_train/valid.txt', help='txtfile path.')
    args = parser.parse_args()
    image_size = [int(x) for x in args.image_size.split(',')]
    img_pairs = read_pairs(args.txtfile)
    img_paths, issame_list = get_paths(img_pairs, 45*7)   # 这里的15925是相同图像对的个数，需要按照实际产生的相同图像对数量替换
    img_bins = []
    i = 0
